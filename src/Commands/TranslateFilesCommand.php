...
class TranslateFilesCommand extends Command
{
  ...
  private static function translate_via_api_key($base_locale, $locale, $text){
    ...
    curl_setopt($handle, CURLOPT_POSTFIELDS, "fromLang=".substr($base_locale, 0, strpos($base_locale."_", "_"))."&text=".rawurlencode($text)."&to=".substr($locale, 0, strpos($locale."_", "_")));
    ...
    return $responseDecoded[0]['translations'][0]['text'];
  }
